...
final _entities = <ModelEntity>[
  ModelEntity(
      ...
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5613422567086320493),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 356789465556142902),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 5724045424950627846),
  ...
  final bindings = <Type, EntityDefinition>{
    entity_employee: EntityDefinition<entity_employee>(
        model: _entities[0],
        toOneRelations: (entity_employee object) => [],
        toManyRelations: (entity_employee object) => {},
        getId: (entity_employee object) => object.id,
        setId: (entity_employee object, int id) {
          object.id = id;
        },
...
/// [entity_employee] entity fields to define ObjectBox queries.
class entity_employee_ {
  /// see [entity_employee.id]
  static final id =
      QueryIntegerProperty<entity_employee>(_entities[0].properties[0]);

  /// see [entity_employee.name]
  static final name =
